...
import { blogPage,seraiBannerMobile, contactLeft, searchField, locationIcon,guestIcon,fiRrCalendar,rockvilleHouse, fiRrArrowSmallRight, fiRsUser, minusSvg, plusSvg,searchIcon } from "../../../assets/images/images";
...
export const useStyles = makeStyles((theme) => ({
    ...
    banner_main: {
        backgroundImage: `url("${blogPage}")`,
        // [theme.breakpoints.down('xs')]: {
        //     backgroundImage: `url("${blogPageMobile}")`,
        // },
    },
    marBottom40:{
        marginBottom:"40px"
    ...
    banner_main: {
        backgroundImage: `url('https://serai-hms.s3.ap-southeast-1.amazonaws.com/hms/images/blogPage.webp')`,
        // [theme.breakpoints.down('xs')]: {
    ...
    // },
    banner_overlay: {
        background: "linear-gradient(180deg, rgba(31, 33, 39, 0.80) 0%, rgba(31, 33, 39, 0.80) 100%)",
        position: "absolute",
        top: "0px",
        left: "0px",
        width: "100%",
