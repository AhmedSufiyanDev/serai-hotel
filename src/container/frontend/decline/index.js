...
function DeclineTranscation(props) {
    return (
        <div>
            ...
            <Container fixed>
                <div className="">
                    <h2 className="book-cnfrm-heading">Insufficient Amount  Transaction is declined</h2>
                </div>
            </Container>
        </div>
    )
...
export default connect(mapStateToProps, mapDispatchToProps)(DeclineTranscation);